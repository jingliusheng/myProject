<template>
    <div class="new">
        ...
        >
            ...
            <img src="./black.png" alt="" v-show="blackPage" class="black-page">
        </scroller>
    </div>
</template>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created(){
            this.$http.get(this.GLOBAL.BASEURL + '/course/my_course', {params: this.searchParams}).then(response => {
