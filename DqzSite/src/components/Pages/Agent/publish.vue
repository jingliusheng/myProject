<template>
   <!-- 查看 -->
   <pubView :AgentPublishObject="selectAgent" @handleBack="handleCancel" v-if="showFlag"></pubView>
    <div class="purchasePublishList" v-else>
      ...
      <div class="searchArea">
        <el-row type="flex" justify="start" align="middle">
          <el-col>
            <span>产品类型：</span>
            <el-select v-model="searchData.categoryid" placeholder="请选择">
              <el-option
    ...
    methods: {
      ...
      toggleShow(edit) {
        ...
        this.$confirm(text, '提示', {
          ...
          this.$axios.post('/agency/agency_check', {
            id: Id,
            isshield: isShow
          }).then((response) => {
      ...
      // 获取数据列表
      getList() {
        this.$axios.post('/agency/agency_list', this.searchData).then(response => {
          let res = response.data;
          setTimeout(() => {
