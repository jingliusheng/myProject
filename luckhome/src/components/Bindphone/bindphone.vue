...
<div class="bindphone">
  ...
  <x-button type="warn" class="bindBtn" :disabled = "all"  @click.native="bind">提交绑定手机</x-button>    
</div>
</template>
...
export default {
  ...
  methods: {
    bind(){
       this.$http.post(this.GLOBAL.BASEURL + "User/bind_phone",this.sendData).then(res=>{
